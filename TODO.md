...
- [x] 21 Behavioral Production Acceptance Gates (G01–G21): Rebuilt `scripts/acceptance.ps1` and `scripts/acceptance` with all 21 production gates, recording command, exit code, duration, artifact hashes, and strictly enforcing classifications (19 PROVEN, 1 SIMULATION-PROVEN, 1 HARDWARE-REQUIRED, 0 FAILED) [PROVEN, 2026-09-25]
